...
# Generated by qmake (2.01a) (Qt 4.8.6) on: ?? 2? 23 15:00:05 2016
# Project:  jiagucoin-qt.pro
# Template: app
# Command: c:\QT\4.8.6\bin\qmake.exe USE_UPNP=- USEQRCODE=1 -o Makefile jiagucoin-qt.pro
#############################################################################
...
Makefile: jiagucoin-qt.pro  c:/QT/4.8.6/mkspecs/default/qmake.conf c:/QT/4.8.6/mkspecs/features/device_config.prf \
	...
	$(QMAKE) USE_UPNP=- USEQRCODE=1 -o Makefile jiagucoin-qt.pro
...
clean: release-clean debug-clean FORCE
	-$(DEL_FILE) D:/jiagucoin/src/leveldb/libleveldb.a;
	-$(DEL_FILE) cd
	-$(DEL_FILE) D:/jiagucoin/src/leveldb
	-$(DEL_FILE) ;
	-$(DEL_FILE) $(MAKE)
	-$(DEL_FILE) clean
...
D:/jiagucoin/src/leveldb/libleveldb.a: FORCE
